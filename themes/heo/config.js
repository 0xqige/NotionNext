const CONFIG = {
  ...
  SITE_CREATE_TIME: '2023-08-29', // 建站日期，用于计算网站运行的第几天

  // 首页顶部通知条滚动内容，如不需要可以留空 []
  NOTICE_BAR: [
    { title: '欢迎来到七哥博客', url: 'https://blog.qige.me' },
  ],

  // 英雄区(首页顶部大卡)
  HERO_TITLE_1: '分享编程',
  HERO_TITLE_2: '与思维认知',
  HERO_TITLE_3: 'blog.qige.me',
  HERO_TITLE_4: '启程',
  HERO_TITLE_5: '七哥链道，一路同行',
  HERO_TITLE_LINK: 'https://blog.qige.me',
  ...
  INFO_CARD_URL: 'https://github.com/0xqige', // 个人资料底部按钮链接
  ...
  SOCIAL_CARD_URL: 'https://docs.blog.qige.me/article/how-to-question',
